...
<div>Inhoud: blablablablaaaaaaaaaaaaaaaaaaaaaaaa</div>
...
<div1>Titel: blablablaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</div1>
...
<div2>Tijd aangemaakt:02-03-1990</div2>

<style type ="text/css">
div3{ border:2px solid red;
position:relative;
width: px;
top:0px;
left:0px;
}</style>
<div3>Tijd gewijzigd</div3>

<style type ="text/css">
div7{ border:2px solid red;
position:relative;
width: px;
top:0px;
left:0px;
}</style>
<div7>Tijd gewijzigd  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam id sagittis nisl. Nulla elementum ligula ac orci commodo sed congue ipsum dignissim. Donec lacinia, eros a posuere mollis, neque nulla iaculis odio, vitae vulputate diam leo eget neque. Vivamus interdum arcu at velit euismod sit amet viverra augue rhoncus. Mauris vel enim eget lorem ultrices vestibulum. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Ut ut orci vulputate nulla malesuada fermentum sed eget lectus. Vivamus ut odio eu enim fermentum congue.</p></div7>

<style type ="text/css">
div4{ border:2px solid red;
position:absolute;
width: px;
top:180px;
left:100px;
}</style>
<div4>Gebruiker:blaaaaaaaaa</div4>

<style type ="text/css">
div5{ border:2px solid red;
position:relative;
width: px;
top:150px;
left:0px;
}</style>
<div5>Status:Online</div5>

<style type ="text/css">
div6{ border:2px solid red;
position:relative;
width: px;
top:150px;
left:0px;
}</style>
<div6>Tags: blaaaaa</div6>
