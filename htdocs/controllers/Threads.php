...
class Controllers_Threads extends Controllers_Base {
	...
	/**
	 * Parses all the URL-parts froom index into the params[]-array using their meaning in this context as key.
	 * 
	 * In this context of threads, the parameters will have relevance on ordering and pagination and so on.
	 * 
	...
	/**
	 * Calculates all parameters needed to make a correct Pagination in a Threads-View.
	 * 
	...
	/**
	 * All threads-listing-views have many things in common, like pagination. We handle them here.
	 * 
	...
	/**
	 * Grabs all unanswered threads in all categories.
	 * 
	 * @uses setupView()
	 */
	...
	/**
	 * Grabs the threads that are marked as invisible, but ONLY IF the current user is admin.
	 * 
	 * @uses setupView()
	 */
	...
	/**
	 * Grabs all the threads related with a category.
	 * 
	 * @uses setupView()
	 */
	...
	/**
	 * Grabs all the threads posted by a user.
	 * 
	 * @uses setupView()
	 */
	...
	/**
	 * Fetches the thread asked and all its replies from the DB. Displays edit, add-reply and/or admin buttons based on the current user.
	 * 
	...
	/**
	 * Controls the thread-form. Lets the either make a new one, or edit the existing one.
	 * 
	 * @author Frank van Luijn <frank@accode.nl>
	 */
	...
	/**
	 * Tries to save a new or edited Thread, based on the form-input, that is checked for consitency.
	 * 
	 * @author Frank van Luijn <frank@accode.nl>
	 */
	...
	/**
	 * Assambles all the proporties needed to make {@link Views_Threads_Form} display the form needed.
